---
ct_id: CT-015
uuid: 62b8433c-f529-4325-a7f1-00ab8494026f
title: "South Park's narratological algorithms"
created_at: 2026-01-22T21:34:21.423382Z
updated_at: 2026-01-22T21:38:25.385284Z
message_count: 4
tags: [ALGO, COMEDY, ANIMATION, CAUSALITY]
source: claude-desktop-export
---

# South Park's narratological algorithms

**CT-015** | 4 messages | Source: Claude Desktop

---

## Human *(2026-01-22 21:34 UTC)*

distill all of South Park's rules as narratological-algorithms;
reference: The South Park But/Therefore Rule: A Complete Craft Analysis.md

---

## Assistant *(2026-01-22 21:35 UTC)*

I have the full document. Let me now produce a formal distillation as narratological-algorithms, following the style of your existing McKee and Larry David algorithm documents.
...
## Human *(2026-01-22 21:36 UTC)*

create markdown document

---

## Assistant *(2026-01-22 21:38 UTC)*

Document complete. Contains 15 sections covering:

- **Axioms** (revision-first philosophy, simplicity principle)
- **Three-word diagnostic** with connector classification and classical theory mapping
- **Six-step testing protocol** with shuffle/status-quo tests as pseudocode
- **Causal chain templates** including canonical "Scott Tenorman" and "Make Love Not Warcraft" breakdowns
- **Production integration** (how the framework enables 6-day turnaround)
- **Quick reference card** for at-a-glance application

Formatted to match the style of your existing McKee and Larry David algorithm documents.
